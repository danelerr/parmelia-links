...
// integrators can tell apart missing vs invalid/revoked keys. 402/422/429 are
// intentionally not used yet:
//   - business-rule violations (e.g. INSUFFICIENT_BALANCE) use 400 for broad
//     proxy/tooling compatibility (422 would be the stricter REST choice);
//   - rate limiting is enforced at the edge (Cloudflare), not per-route.
//
...
export const ERR = {
	...
	// ---- 401 Unauthorized: /v1 API key auth (machine-to-machine) ----
