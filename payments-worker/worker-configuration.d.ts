/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --env-interface=CloudflareBindings` (hash: 1443cbcab8139283cf854f3571565cf8)
...
interface __BaseEnv_CloudflareBindings {
	...
	PAYMENTS_BOOTSTRAP_MODE: "false";
	PAYMENTS_DATA_CUTOVER_CHECKSUM: "5d3093e9b12288d7783832037b3bf06635591da1cf56df377ff4b4b6f3093a27";
	...
	PAYMENT_AUTHORIZATION_SIGNER_PRIVATE_KEY: string;
	PAYMENT_ROUTER_PREFLIGHT_ENABLED: string;
	PAYMENT_FEE_POLICY_JSON: string;
	PAYMENT_PLATFORM_FEE_RECIPIENT: string;
	PAYMENT_RPC_URLS: string;
	PAYMENT_RELAYER_PRIVATE_KEY: string;
	PAYMENT_CONFIRMATIONS_JSON: string;
	...
	PAYMENT_JOB_SCHEDULER: DurableObjectNamespace<import("./src/index").PaymentJobScheduler>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PaymentJobScheduler";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FIREBASE_PROJECT_ID" | "ALLOWED_ORIGINS" | "SETTLEMENT_CHAIN_ID" | "PAYMENT_ENABLED_CHAIN_IDS" | "PAYMENT_LIVE_ENABLED" | "PAYMENTS_BOOTSTRAP_MODE" | "PAYMENTS_DATA_CUTOVER_CHECKSUM" | "PAYMENT_AUTHORIZATION_TTL_SECONDS" | "CIRCLE_API_BASE_URL" | "CHECKOUT_BASE_URL" | "PAYMENT_AUTHORIZATION_SIGNER_PRIVATE_KEY" | "PAYMENT_ROUTER_PREFLIGHT_ENABLED" | "PAYMENT_FEE_POLICY_JSON" | "PAYMENT_PLATFORM_FEE_RECIPIENT" | "PAYMENT_RPC_URLS" | "PAYMENT_RELAYER_PRIVATE_KEY" | "PAYMENT_CONFIRMATIONS_JSON" | "WEBHOOK_SECRET_ENCRYPTION_KEY" | "WEBHOOK_SECRET_ENCRYPTION_KEY_ID" | "WEBHOOK_SECRET_ENCRYPTION_KEYS_PREVIOUS" | "CIRCLE_API_KEY" | "OPS_HEALTH_TOKEN">> {}
}
