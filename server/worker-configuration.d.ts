/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --env-interface=CloudflareBindings` (hash: 3be52bd71ae3bd701541d1101c86938d)
// Runtime types generated with workerd@1.20260804.1 2026-07-26 nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FIREBASE_PROJECT_ID" | "ALLOWED_ORIGINS" | "RPC_URL" | "RPC_READ_URLS" | "RPC_WRITE_URLS" | "RPC_INDEXER_URLS" | "RPC_ARCHIVE_URLS" | "RPC_TIMEOUT_MS" | "RPC_PROVIDER_CAPABILITIES" | "RELAYER_MODE" | "BUNDLER_RPC_URLS" | "BUNDLER_ROLLOUT_PERCENT" | "BUNDLER_DUMMY_SIGNATURE" | "BUNDLER_SELF_FALLBACK" | "RPC_INDEXER_MIN_BLOCK_RANGE" | "RPC_INDEXER_MAX_BLOCK_RANGE" | "INDEXER_WALLET_SHARD_SIZE" | "INDEXER_REGISTRY_BATCH_SIZE" | "INDEXER_MAX_RPC_CALLS_PER_JOB" | "INDEXER_MAX_BLOCKS_PER_JOB" | "INDEXER_MAX_EVENT_BLOCKS_PER_JOB" | "INDEXER_SAFETY_SWEEP_SECONDS" | "BALANCE_MAX_STALENESS_SECONDS" | "ARBITRUM_L1_CONFIRMATIONS_REQUIRED" | "ALCHEMY_WEBHOOK_ENABLED" | "ALCHEMY_CUSTOM_WEBHOOK_ENABLED" | "ALCHEMY_CUSTOM_WEBHOOK_ID" | "ALCHEMY_CUSTOM_WEBHOOK_SIGNING_KEY" | "ALCHEMY_WEBHOOK_ID" | "ALCHEMY_WEBHOOK_NETWORK" | "ALCHEMY_WEBHOOK_SIGNING_KEY" | "ALCHEMY_ADDRESS_WEBHOOKS_JSON" | "ALCHEMY_NOTIFY_AUTH_TOKEN" | "PRIVATE_KEY" | "FAUCET_PRIVATE_KEY" | "RECOVERY_GUARDIAN_PRIVATE_KEY" | "PAYMASTER_SIGNER_PRIVATE_KEY" | "PAYMENT_ROUTER_SIGNER_PRIVATE_KEY" | "WEBHOOK_SECRET_ENCRYPTION_KEY" | "WEBHOOK_SECRET_ENCRYPTION_KEY_ID" | "WEBHOOK_SECRET_ENCRYPTION_KEYS_PREVIOUS" | "CHAIN_KEY" | "TURNSTILE_SECRET_KEY" | "FAUCET_ENABLED" | "FAUCET_DAILY_BUDGET_USDC" | "FCM_SERVICE_ACCOUNT" | "APP_URL" | "GATOPAGO_FEES_ENABLED" | "GATOPAGO_SWAP_FEE_BPS" | "GATOPAGO_MAX_FEE_BPS" | "GATOPAGO_TREASURY_ADDRESS" | "GATOPAGO_CROSSCHAIN_FEE_BPS" | "GATOPAGO_PAYMENT_FEE_BPS" | "CCTP_RPC_URLS" | "CROSSCHAIN_PAUSED" | "CROSSCHAIN_DISABLED_CHAINS" | "CROSSCHAIN_MIN_RELAYER_GAS_WEI" | "EARN_PAUSED">> {}
}
