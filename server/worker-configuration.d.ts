/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --env-interface=CloudflareBindings` (hash: 8f2c87355ea7999dfdfcc5aaae95b0d5)
// Runtime types generated with workerd@1.20260714.1 2026-07-13 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	PARMELIA_DB: D1Database;
	BALANCE_REFRESH_QUEUE: Queue;
	...
	BALANCE_RPC_ONLY_REFRESH_SECONDS: string;
	BALANCE_MAINTENANCE_BATCH_SIZE: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FIREBASE_PROJECT_ID" | "ALLOWED_ORIGINS" | "RPC_URL" | "RPC_READ_URLS" | "RPC_WRITE_URLS" | "RPC_INDEXER_URLS" | "RPC_ARCHIVE_URLS" | "RPC_TIMEOUT_MS" | "RELAYER_MODE" | "BUNDLER_RPC_URLS" | "BUNDLER_ROLLOUT_PERCENT" | "BUNDLER_DUMMY_SIGNATURE" | "BUNDLER_SELF_FALLBACK" | "RPC_INDEXER_MIN_BLOCK_RANGE" | "RPC_INDEXER_MAX_BLOCK_RANGE" | "INDEXER_WALLET_SHARD_SIZE" | "BALANCE_MAX_STALENESS_SECONDS" | "BALANCE_RPC_ONLY_REFRESH_SECONDS" | "BALANCE_MAINTENANCE_BATCH_SIZE" | "ARBITRUM_L1_CONFIRMATIONS_REQUIRED" | "ALCHEMY_WEBHOOK_ENABLED" | "ALCHEMY_WEBHOOK_ID" | "ALCHEMY_WEBHOOK_NETWORK" | "ALCHEMY_WEBHOOK_SIGNING_KEY" | "ALCHEMY_NOTIFY_AUTH_TOKEN" | "PRIVATE_KEY" | "FAUCET_PRIVATE_KEY" | "RECOVERY_GUARDIAN_PRIVATE_KEY" | "PAYMASTER_SIGNER_PRIVATE_KEY" | "PAYMENT_ROUTER_SIGNER_PRIVATE_KEY" | "WEBHOOK_SECRET_ENCRYPTION_KEY" | "WEBHOOK_SECRET_ENCRYPTION_KEY_ID" | "WEBHOOK_SECRET_ENCRYPTION_KEYS_PREVIOUS" | "CHAIN_KEY" | "TURNSTILE_SECRET_KEY" | "FAUCET_ENABLED" | "FAUCET_DAILY_BUDGET_USDC" | "FCM_SERVICE_ACCOUNT" | "APP_URL" | "PARMELIA_FEES_ENABLED" | "PARMELIA_SWAP_FEE_BPS" | "PARMELIA_MAX_FEE_BPS" | "PARMELIA_TREASURY_ADDRESS" | "PARMELIA_CROSSCHAIN_FEE_BPS" | "PARMELIA_PAYMENT_FEE_BPS" | "CCTP_RPC_URLS" | "CROSSCHAIN_PAUSED" | "CROSSCHAIN_DISABLED_CHAINS" | "CROSSCHAIN_MIN_RELAYER_GAS_WEI" | "EARN_PAUSED">> {}
}
