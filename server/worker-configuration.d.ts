/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --env-interface=CloudflareBindings` (hash: 51cada5c7653b540dd47655483767157)
// Runtime types generated with workerd@1.20260820.1 2026-08-25 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	GATOPAGO_DB: D1Database;
	EMAIL: SendEmail;
	SCHEDULED_JOBS_QUEUE: Queue;
	...
	RPC_URL: string;
	RPC_READ_URLS: string;
	RPC_WRITE_URLS: string;
	RPC_INDEXER_URLS: string;
	RPC_ARCHIVE_URLS: string;
	RPC_TIMEOUT_MS: string;
	RPC_PROVIDER_CAPABILITIES: string;
	RELAYER_MODE: string;
	BUNDLER_RPC_URLS: string;
	BUNDLER_ROLLOUT_PERCENT: string;
	BUNDLER_DUMMY_SIGNATURE: string;
	BUNDLER_SELF_FALLBACK: string;
	RPC_INDEXER_MIN_BLOCK_RANGE: string;
	RPC_INDEXER_MAX_BLOCK_RANGE: string;
	INDEXER_WALLET_SHARD_SIZE: string;
	INDEXER_REGISTRY_BATCH_SIZE: string;
	INDEXER_MAX_RPC_CALLS_PER_JOB: string;
	INDEXER_MAX_BLOCKS_PER_JOB: string;
	INDEXER_MAX_EVENT_BLOCKS_PER_JOB: string;
	INDEXER_SAFETY_SWEEP_SECONDS: string;
	BALANCE_MAX_STALENESS_SECONDS: string;
	ARBITRUM_L1_CONFIRMATIONS_REQUIRED: string;
	ALCHEMY_WEBHOOK_ENABLED: string;
	ALCHEMY_CUSTOM_WEBHOOK_ENABLED: string;
	ALCHEMY_CUSTOM_WEBHOOK_ID: string;
	ALCHEMY_CUSTOM_WEBHOOK_SIGNING_KEY: string;
	ALCHEMY_WEBHOOK_ID: string;
	ALCHEMY_WEBHOOK_NETWORK: string;
	ALCHEMY_WEBHOOK_SIGNING_KEY: string;
	ALCHEMY_ADDRESS_WEBHOOKS_JSON: string;
	ALCHEMY_NOTIFY_AUTH_TOKEN: string;
	PRIVATE_KEY: string;
	FAUCET_PRIVATE_KEY: string;
	RECOVERY_GUARDIAN_PRIVATE_KEY: string;
	PAYMASTER_SIGNER_PRIVATE_KEY: string;
	SPONSORSHIP_PROVIDER: string;
	SPONSORSHIP_FALLBACK_PROVIDER: string;
	SPONSORSHIP_PAYMASTER_ADDRESS: string;
	SPONSORSHIP_HEALTH_CHECK_ENABLED: string;
	PAYMASTER_MIN_DEPOSIT_WEI: string;
	PAYMASTER_SERVICE_URL: string;
	PAYMASTER_SERVICE_CONTEXT_JSON: string;
	PAYMASTER_SERVICE_EXPECTED_PAYMASTER: string;
	PAYMASTER_SERVICE_TIMEOUT_MS: string;
	GATOPAGO_FEES_ENABLED: string;
	GATOPAGO_SWAP_FEE_BPS: string;
	GATOPAGO_CROSSCHAIN_FEE_BPS: string;
	GATOPAGO_MAX_FEE_BPS: string;
	GATOPAGO_TREASURY_ADDRESS: string;
	PAYMENT_ROUTER_SIGNER_PRIVATE_KEY: string;
	WEBHOOK_SECRET_ENCRYPTION_KEY: string;
	WEBHOOK_SECRET_ENCRYPTION_KEY_ID: string;
	WEBHOOK_SECRET_ENCRYPTION_KEYS_PREVIOUS: string;
	CHAIN_KEY: string;
	APP_ENABLED_CHAIN_KEYS: string;
	APP_WALLET_RAIL_CHAIN_KEYS: string;
	APP_CHAIN_RPC_URLS: string;
	TURNSTILE_SECRET_KEY: string;
	FAUCET_ENABLED: string;
	FAUCET_DAILY_BUDGET_USDC: string;
	...
	CCTP_RPC_URLS: string;
	CROSSCHAIN_PAUSED: string;
	CROSSCHAIN_DISABLED_CHAINS: string;
	CROSSCHAIN_MIN_RELAYER_GAS_WEI: string;
	EARN_PAUSED: string;
	EVENT_JOB_SCHEDULER: DurableObjectNamespace<import("./src/index").EventJobScheduler>;
	RPC_ADMISSION: DurableObjectNamespace<import("./src/index").RpcAdmissionController>;
	PAYMENTS: Fetcher /* gatopago-payments-api */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "EventJobScheduler" | "RpcAdmissionController";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FIREBASE_PROJECT_ID" | "PAYMENTS_CUTOVER_MODE" | "PAYMENTS_SYNC_ENABLED" | "ALLOWED_ORIGINS" | "OPS_HEALTH_TOKEN" | "RPC_URL" | "RPC_READ_URLS" | "RPC_WRITE_URLS" | "RPC_INDEXER_URLS" | "RPC_ARCHIVE_URLS" | "RPC_TIMEOUT_MS" | "RPC_PROVIDER_CAPABILITIES" | "RELAYER_MODE" | "BUNDLER_RPC_URLS" | "BUNDLER_ROLLOUT_PERCENT" | "BUNDLER_DUMMY_SIGNATURE" | "BUNDLER_SELF_FALLBACK" | "RPC_INDEXER_MIN_BLOCK_RANGE" | "RPC_INDEXER_MAX_BLOCK_RANGE" | "INDEXER_WALLET_SHARD_SIZE" | "INDEXER_REGISTRY_BATCH_SIZE" | "INDEXER_MAX_RPC_CALLS_PER_JOB" | "INDEXER_MAX_BLOCKS_PER_JOB" | "INDEXER_MAX_EVENT_BLOCKS_PER_JOB" | "INDEXER_SAFETY_SWEEP_SECONDS" | "BALANCE_MAX_STALENESS_SECONDS" | "ARBITRUM_L1_CONFIRMATIONS_REQUIRED" | "ALCHEMY_WEBHOOK_ENABLED" | "ALCHEMY_CUSTOM_WEBHOOK_ENABLED" | "ALCHEMY_CUSTOM_WEBHOOK_ID" | "ALCHEMY_CUSTOM_WEBHOOK_SIGNING_KEY" | "ALCHEMY_WEBHOOK_ID" | "ALCHEMY_WEBHOOK_NETWORK" | "ALCHEMY_WEBHOOK_SIGNING_KEY" | "ALCHEMY_ADDRESS_WEBHOOKS_JSON" | "ALCHEMY_NOTIFY_AUTH_TOKEN" | "PRIVATE_KEY" | "FAUCET_PRIVATE_KEY" | "RECOVERY_GUARDIAN_PRIVATE_KEY" | "PAYMASTER_SIGNER_PRIVATE_KEY" | "SPONSORSHIP_PROVIDER" | "SPONSORSHIP_FALLBACK_PROVIDER" | "SPONSORSHIP_PAYMASTER_ADDRESS" | "SPONSORSHIP_HEALTH_CHECK_ENABLED" | "PAYMASTER_MIN_DEPOSIT_WEI" | "PAYMASTER_SERVICE_URL" | "PAYMASTER_SERVICE_CONTEXT_JSON" | "PAYMASTER_SERVICE_EXPECTED_PAYMASTER" | "PAYMASTER_SERVICE_TIMEOUT_MS" | "GATOPAGO_FEES_ENABLED" | "GATOPAGO_SWAP_FEE_BPS" | "GATOPAGO_CROSSCHAIN_FEE_BPS" | "GATOPAGO_MAX_FEE_BPS" | "GATOPAGO_TREASURY_ADDRESS" | "PAYMENT_ROUTER_SIGNER_PRIVATE_KEY" | "WEBHOOK_SECRET_ENCRYPTION_KEY" | "WEBHOOK_SECRET_ENCRYPTION_KEY_ID" | "WEBHOOK_SECRET_ENCRYPTION_KEYS_PREVIOUS" | "CHAIN_KEY" | "APP_ENABLED_CHAIN_KEYS" | "APP_WALLET_RAIL_CHAIN_KEYS" | "APP_CHAIN_RPC_URLS" | "TURNSTILE_SECRET_KEY" | "FAUCET_ENABLED" | "FAUCET_DAILY_BUDGET_USDC" | "FCM_SERVICE_ACCOUNT" | "FIREBASE_SERVICE_ACCOUNT" | "FIREBASE_WEB_API_KEY" | "AUTH_CODE_PEPPER" | "AUTH_EMAIL_FROM" | "APP_URL" | "PASSKEY_RP_ID" | "PASSKEY_ALLOWED_ORIGINS" | "CCTP_RPC_URLS" | "CROSSCHAIN_PAUSED" | "CROSSCHAIN_DISABLED_CHAINS" | "CROSSCHAIN_MIN_RELAYER_GAS_WEI" | "EARN_PAUSED">> {}
}
